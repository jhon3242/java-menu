...
public class ApplicationTest extends NsTest {
    ...
    class AllFeatureTest {
        ...
        @DisplayName("카테코리는 최대 2회 중복될 수 있고 메뉴는 중복될 수 없다.")
        @Test
        void 기능_테스트2() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                ...
                assertRandomTest(executable,
                        ...
                        Mocking.ofShuffle(
                                ...
                                // 화요일
                                List.of("김치찌개", "김밥", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이", "제육볶음"),    // 구구
                                List.of("제육볶음", "김밥", "김치찌개", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이"),    // 구구

                                List.of("제육볶음", "김밥", "김치찌개", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이"),    // 제임스
                                List.of("김치찌개", "김밥", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이", "제육볶음"),    // 제임스
        ...
        @DisplayName("코치 이름 설정에서 에러 발생시 에러 출력 후 다시 입력 받는다.")
        @Test
        void successWithCoachNameError() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                    runException("구구", "구구 제임스", "구구,제임스", "김밥", "떡볶이");
        ...
        @DisplayName("못먹는 메뉴 설정에서 에러 발생시 에러 출력 후 다시 입력 받는다.")
        @Test
        void successWithExceptionMenuError() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                    runException("구구,제임스", "없는 메뉴", "김밥,제육볶음,떡볶이", "김밥", "떡볶이");
