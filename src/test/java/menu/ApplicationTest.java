...
public class ApplicationTest extends NsTest {
    ...
    class AllFeatureTest {
        ...
        void 기능_테스트2() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                    runException("구구,제임스", "파인애플 볶음밥,김밥", "떡볶이,김밥");
        ...
        void 없는_메뉴를_포함한_경우() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                    runException("구구,제임스", "없는메뉴", "김밥", "떡볶이,김밥");
            ...
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                ...
                assertRandomTest(executable,
                        ...
                        Mocking.ofShuffle(
                                ...
                                List.of("김밥", "쌈밥", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이", "제육볶음"),    // 구구
                                List.of("김치찌개", "김밥", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이", "제육볶음"),    // 구구
                                List.of("제육볶음", "김밥", "김치찌개", "쌈밥", "된장찌개", "비빔밥", "칼국수", "불고기", "떡볶이"),    // 제임스
        ...
        @Test
        void 코치_이름_구분자가_잘못된_경우() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                    runException("구구 제임스", "구구,제임스", "김밥", "떡볶이,김밥");
        ...
        void 코치_수가_잘못된_경우() {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                final Executable executable = () -> {
                    runException("구구", "구구,피피,지지,카카,초초,프푸", "구구,제임스", "김밥", "떡볶이,김밥");
